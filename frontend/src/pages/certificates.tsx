      ...
      <div className="relative z-10 pt-20 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <FadeIn direction="up">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 drop-shadow-lg">Certificates</h1>
          ...
          <div className="max-w-4xl mx-auto bg-gray-800/40 backdrop-blur-md rounded-xl p-8 border border-gray-700/50 shadow-xl">
