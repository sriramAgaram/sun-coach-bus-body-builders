...
const Service = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0d1419] text-white" style={{ fontFamily: 'Manrope, "Noto Sans", sans-serif' }}>
      {/* Hero Section */}
      <section className="relative py-20 md:py-32 bg-linear-to-b from-[#111a22] via-[#0d1419] to-[#0d1419] overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            {servicesData.services.map((service: any) => (
              <div
                key={service.id}
                className="group relative bg-linear-to-br from-gray-800/50 via-gray-800/30 to-gray-900/50 rounded-2xl p-8 md:p-10 border border-gray-700/50 hover:border-blue-600/50 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-600/10 hover:-translate-y-2 overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-start gap-6 mb-6">
                    <div className="shrink-0 w-20 h-20 bg-linear-to-br from-blue-600/20 to-blue-800/20 rounded-2xl flex items-center justify-center text-blue-400 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500 border border-blue-600/30 backdrop-blur-sm">
                  ...
                  <div className="bg-linear-to-br from-gray-900/80 to-gray-800/50 rounded-xl p-6 border border-gray-700/50 backdrop-blur-sm">
                    <div className="flex items-center gap-2 mb-5">
                      <div className="w-1 h-6 bg-linear-to-b from-blue-600 to-blue-400 rounded-full"></div>
                      ...
                      {service.keyFeatures.map((feature: string, featureIndex: number) => (
                        <li key={featureIndex} className="flex items-start gap-3 group/feature">
                          <div className="shrink-0 mt-1">
                            <div className="w-6 h-6 rounded-full bg-linear-to-br from-green-500/20 to-green-600/20 border border-green-500/30 flex items-center justify-center group-hover/feature:scale-110 transition-transform duration-300">
                              <svg
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-24 bg-linear-to-b from-[#0d1419] to-[#111a22]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-linear-to-br from-blue-600/10 via-blue-700/5 to-transparent rounded-2xl p-8 md:p-12 border border-blue-600/20 backdrop-blur-sm">
